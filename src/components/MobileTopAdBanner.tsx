...
export const MobileTopAdBanner: React.FC<MobileTopAdBannerProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-14 sm:h-16 rounded-xl overflow-hidden border border-zinc-800/90 hover:border-emerald-500/40 transition-colors bg-black shadow-lg">
        <a
